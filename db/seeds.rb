...
15.times do |n|
  Product.create(title: "Product  №#{n}", description: "Book#{n} is a very interesting book", price: rand(100..999), category_ids: ['1'])
end

15.times do |n|
  Product.create(title: "Product  №#{n}", description: "Book#{n} is a very interesting book", price: rand(100..999), category_ids: ['2'])
end

15.times do |n|
  Product.create(title: "Product  №#{n}", description: "Book#{n} is a very interesting book", price: rand(100..999), category_ids: ['3'])
end
